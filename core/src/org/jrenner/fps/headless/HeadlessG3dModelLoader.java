...
public class HeadlessG3dModelLoader extends HeadlessModelLoader<HeadlessModelLoader.HeadlessModelParameters> {
	public static final short VERSION_HI = 0;
	public static final short VERSION_LO = 1;
	protected final BaseJsonReader reader;

	public HeadlessG3dModelLoader(final BaseJsonReader reader) {
		this(reader, null);
	}
	...
	@Override
	public ModelData loadModelData (FileHandle fileHandle, HeadlessModelParameters parameters) {
